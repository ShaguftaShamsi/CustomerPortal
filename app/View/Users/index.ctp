...
echo $this->Form->input('email',array('label'=>'','placeholder'=>'Enter Your Email Here'));
echo $this->Form->input('password',array('label'=>'','placeholder'=>'Enter Your Password Here'));
?>
<p></p>
<?php
